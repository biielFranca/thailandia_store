        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.6fr_1fr_1fr_1fr]">
          ...
          <div>
            ...
            <div className="mt-5 flex gap-2">
              <a href="https://www.instagram.com/thailandia_store/" target="_blank" rel="noopener noreferrer"
                className="inline-flex h-9 w-9 items-center justify-center rounded-[8px] border transition-colors duration-200 hover:[border-color:var(--border-strong)] hover:[color:var(--text-primary)]"
